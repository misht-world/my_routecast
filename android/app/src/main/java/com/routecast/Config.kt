...
object Config {
    ...
    const val MIN_VERTEX_DEG = 12.0 // порог включения вершины в поворотное событие
    const val TURN_MIN_DEG = 35.0   // порог нетто-угла для выдачи манёвра
    const val MERGE_DIST_M = 25.0   // прямой участок, закрывающий событие
